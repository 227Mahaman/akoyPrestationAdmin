...
if (!empty($_SESSION['user-akoyprestation']['entity'])) {
  $uniqueID = $_SESSION['user-akoyprestation']['entity']['uniqueId'];
...
<br>
<?php if ($_SESSION['user-akoyprestation']['roleId'] == 1  && empty($uniqueID) && empty($_GET['uniqueId'])) : ?>
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="card">
...
<?php else : ?>
  <div class="container">
    <div class="row">
      <?php
      // var_dump($_SESSION['user-akoyprestation']['entity']);
      ...
      <?php else : ?>
        ...
        <div class="col-md-12 container-margin" style="margin-bottom: 100px;">
          <div class="card">
            ...
            <div class="card-body">
              <pre>
                <p><b><i>Endpoint: <a href="https://IslamNiger.akoybiz.com/index.php?api=addDocument">https://IslamNiger.akoybiz.com/index.php?api=addDocument</a></i></b></p>
                <!-- <br> -->
