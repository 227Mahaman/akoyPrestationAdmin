...
/*new req 07/07/2021*/
ALTER TABLE `pharmacies` CHANGE `adresse` `adresse` TEXT CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL;
ALTER TABLE `groupe_pharmacies` ADD `user_create` INT NOT NULL AFTER `statut`;