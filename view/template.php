...
<body class="vertical-layout">
    ...
    <div id="containerbar">
        ...
        <div class="rightbar">
                            ...
                            <ul class="list-inline mb-0">
                                ...
                                <li class="list-inline-item">
                                    <div class="profilebar">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle" href="#" role="button" id="profilelink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?= !empty($_SESSION['user-akoyprestation']['photo']) ? $_SESSION['user-akoyprestation']['photo'] : 'public/img/avatar.png' ?>" class="img-fluid" alt="profile"><span class="feather icon-chevron-down live-icon"></span></a>
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                                <div class="dropdown-item">
                                                    <div class="profilename">
                                                        <h5><?= $_SESSION['user-akoyprestation']['first_name'] . ' ' . $_SESSION['user-akoyprestation']['last_name'] ?></h5>
                                                    </div>
                                                </div>
                                                <div class="userbox">
            ...
            <div class="footerbar">
                <footer class="footer">
                    <p class="mb-0">© 2021 AkoyPrestation - Tous droits reservés.</p>
                </footer>
            </div>
            <!-- End Footerbar -->
        </div>
